            ...
            <section className="w-full max-w-4xl py-12 md:py-24">
                <div className="container px-4 md:px-6">
                    ...
                    <div className="mt-12 space-y-8 text-gray-600">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mt-10">Key Features</h2>
                        <div className="card p-6 rounded-lg border border-gray-200">
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mt-10">Our Technology</h2>
                        <div className="card p-6 rounded-lg border border-gray-200">
                            <p>
                        ...
                        <h2 className="text-2xl font-bold text-gray-900 mt-10">Get Started</h2>
                        <div className="card p-6 rounded-lg border border-gray-200">
                            <p>
